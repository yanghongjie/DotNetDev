...
namespace Dev.Exceptions
{
    ...
    {
        /// <summary>
        ///     初始化<see cref="DevException" />类的新实例
        /// </summary>
        public DevException()
        {
        }
        ...
        /// <summary>
        ///     使用指定错误消息初始化<see cref="DevException" />类的新实例。
        /// </summary>
        ...
        /// <summary>
        ///     使用异常消息与一个内部异常实例化一个<see cref="DevException" />类的新实例
        /// </summary>
        /// <param name="message">异常消息</param>
        /// <param name="inner">用于封装在<see cref="DevException" />内部的异常实例</param>
        public DevException(string message, Exception inner) : base(message, inner)
        {
        }

        /// <summary>
        ///     使用可序列化数据实例化一个<see cref="DevException" />类的新实例
        /// </summary>
