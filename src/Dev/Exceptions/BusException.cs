...
namespace Dev.Exceptions
{
    ...
    /// </summary>
    [Serializable]
    public class BusException : DevException
    {
        /// <summary>
        /// 初始化<see cref="BusException"/>类的新实例
        /// </summary>
        public BusException() { }

        /// <summary>
        /// 使用指定错误消息初始化<see cref="BusException"/>类的新实例。
        /// </summary>
        /// <param name="message">描述错误的消息</param>
        public BusException(string message) : base(message) { }

        /// <summary>
        /// 使用异常消息与一个内部异常实例化一个<see cref="BusException"/>类的新实例
        /// </summary>
        /// <param name="message">异常消息</param>
        /// <param name="inner">用于封装在<see cref="BusException"/>内部的异常实例</param>
        public BusException(string message, Exception inner) : base(message, inner) { }

        /// <summary>
        /// 使用可序列化数据实例化一个<see cref="BusException"/>类的新实例
        /// </summary>
